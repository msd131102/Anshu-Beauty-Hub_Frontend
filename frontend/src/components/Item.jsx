...
// Backend base URL
const BACKEND_URL = 'https://anshu-beauty-hub-backend.onrender.com';
      ...
      <div className={itemsPageStyles.container}>
        <header className={itemsPageStyles.header}>
          ...
          <h1 className={itemsPageStyles.mainTitle}>
            <span className={itemsPageStyles.titleSpan}>𝔸ℕ𝕊ℍ𝕌</span> 𝔹𝔼𝔸𝕌𝕋𝕐 ℍ𝕌𝔹
          </h1>

          <p className={itemsPageStyles.subtitle}>
            Premium natural beauty products crafted from pure herbal ingredients
          </p>
        ...
        <div className={itemsPageStyles.searchContainer}>
          ...
          >
            <input
              ...
              placeholder="Search haircare, skincare, bodycare... all pure and herbal..."
