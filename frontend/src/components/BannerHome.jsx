...
import BannerFood from '../assets/FoodBanner.jpeg';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <p className={bannerStyles.paragraph}>
              Discover our range of herbal and natural beauty products, crafted with care for healthy skin and hair.
            </p>
            ...
            <form onSubmit={handleSubmit} className={bannerStyles.form}>
              <input
                ...
                placeholder="Search for shampoos, creams, lotions..."
